...
#   autostart = true
# }
# data.template_file.network_config_worker_hv_rack["k8s-worker-5"]
# data.template_file.user_data_worker_hv_rack["k8s-worker-5"]
# libvirt_cloudinit_disk.commoninit-worker_hv_rack["k8s-worker-5"]
# libvirt_domain.domain-debian-worker_hv_rack["k8s-worker-5"]
# libvirt_pool.k8s_hv_rack
# libvirt_volume.root_cloudinit_hv_rack
# libvirt_volume.worker_hv_rack["k8s-worker-5"]